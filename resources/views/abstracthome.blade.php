...
<div class="container">
    <div class="row">
        <div class="col-md-10">
            ...
            <p>Welcome to the online portal of submission of abstracts for the <b>SILVER JUBILEE SAFOG CONFERENCE</b> in association with 53rd ANNUAL CONGRESS OF THE SLCOG. All Submissions must be made through this portal.</p>
            <p>Please follow the guidelines stipulated by the Committee when submitting abstracts. For a downloadable version of the guidelines please see above.</p>
            
            <p>The Process of submission.</p>
            <ol>
  ...
  <li class=""> <a href="http://safogslcog2020.com/storage/files/Guidelines for Abstracts Submission.pdf" target="_blanck">
    Abstract Submission Guidelines </a></li>

    <li > <a href="http://safogslcog2020.com/storage/files/Guidelines for Poster Presentations - 2020.pdf" target="_blanck">
  ...
  <h2><a href="{{ route('login') }}" class="btn btn-primary">Submit Abstract </a></h2>
            </div>
            </div>
        </div>
